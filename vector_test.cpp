...
void    iterators_test()
{
    ...
    std::cout << "it++ lib: " << *(it3++) << std::endl;
    std::cout << "it++  my: " << *(itm3++) << std::endl;
    std::cout << "++it lib: " << *(++it3) << std::endl;
    std::cout << "++it  my: " << *(++itm3) << std::endl;
    std::cout << "--it lib: " << *(--it3) << std::endl;
    std::cout << "--it  my: " << *(--itm3) << std::endl;
...
void    capacity_tests() {
    ...
    std::cout << std::endl;
    std::cout << "max size lib: " << lib1.max_size() << std::endl;
    std::cout << "max size  my: " << my1.max_size() << std::endl;
    lib1.resize(7);
    my1.resize(7);
...
void    element_access_test()
{
    ...
    printList(lib);
    std::cout << std::endl;
    std::cout << "my front(): " << my.front() << " ,content: ";
    printList(my);
    std::cout << std::endl;
    std::cout << "lib back(): " << lib.back() << " ,content: ";
    printList(lib);
    std::cout << std::endl;
    std::cout << "my back(): " << my.back() << " ,content: ";
    printList(my);
    std::cout << std::endl;
    lib.push_back(8);
    my.push_back(8);
    std::cout << "push in the end, now lib back(): " << lib.back() << " ,content: ";
    printList(lib);
    std::cout << std::endl;
    std::cout << "push in the end, now  my back(): " << my.back() << " ,content: ";
    printList(my);
}
...
void    push_pop_tests()
{
    ...
    std::cout << "INSERT LIB: ret value: " << *vLib2.insert(vLib2.end(), 33) << std::endl;
    vector_info(vLib2, "", "insert one value in end");
    std::cout << "INSERT MY: ret value: " << *vMy2.insert(vMy2.end(), 33) << std::endl;
    vector_info(vMy2, "", "insert one value in end");
    std::cout << "INSERT LIB: ret value: " << *vLib2.insert(vLib2.end(), 1) << std::endl;
    vector_info(vLib2, "", "insert one value in end");
    std::cout << "INSERT MY: ret value: " << *vMy2.insert(vMy2.end(), 1) << std::endl;
    vector_info(vMy2, "", "insert one value in end");
    std::cout << "INSERT LIB: ret value: " << *vLib2.insert(vLib2.end(), 45) << std::endl;
    vector_info(vLib2, "", "insert one value in end");
    std::cout << "INSERT MY: ret value: " << *vMy2.insert(vMy2.end(), 45) << std::endl;
    vector_info(vMy2, "", "insert one value in end");
    std::cout << "INSERT LIB: ret value: " << *vLib2.insert(vLib2.end(), 45) << std::endl;
    vector_info(vLib2, "", "insert one value in end");
    std::cout << "INSERT MY: ret value: " << *vMy2.insert(vMy2.end(), 45) << std::endl;
    ...
    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.begin(), 33) << std::endl;
    vector_info(vLib3, "", "insert one value in begin");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.begin(), 33) << std::endl;
    vector_info(vMy3, "", "insert one value in begin");
    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.begin(), 2) << std::endl;
    vector_info(vLib3, "", "insert one value in begin");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.begin(), 2) << std::endl;
    vector_info(vMy3, "", "insert one value in begin");
    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.begin(), 10) << std::endl;
    vector_info(vLib3, "", "insert one value in begin");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.begin(), 10) << std::endl;
    vector_info(vMy3, "", "insert one value in begin");

    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.begin() + 2, 12) << std::endl;
    vector_info(vLib3, "", "insert one value in middle");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.begin() + 2, 12) << std::endl;
    vector_info(vMy3, "", "insert one value in middle");
    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.begin() + 1, 6) << std::endl;
    vector_info(vLib3, "", "insert one value in middle");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.begin() + 1, 6) << std::endl;
    vector_info(vMy3, "", "insert one value in middle");
    std::cout << "INSERT LIB: ret value: " << *vLib3.insert(vLib3.end() - 3, 7) << std::endl;
    vector_info(vLib3, "", "insert one value in middle");
    std::cout << "INSERT MY: ret value: " << *vMy3.insert(vMy3.end() - 3, 7) << std::endl;
    vector_info(vMy3, "", "insert one value in middle");
    ...
    vector_info(vLib4, "", "insert 2 values in middle");
    vMy4.insert(vMy4.begin() ,(size_t)1, 45);
    std::cout << "INSERT MY" << std::endl;
    vector_info(vMy4, "", "insert 2 values in middle");

    std::cout << "INSERT LIB" << std::endl;
    vLib4.insert(vLib4.begin() ,(size_t)14, 45);
    vector_info(vLib4, "", "insert 2 values in middle");
    vMy4.insert(vMy4.begin() ,(size_t)14, 45);
    std::cout << "INSERT MY" << std::endl;
    vector_info(vMy4, "", "insert 2 values in middle");
    std::cout << "INSERT LIB" << std::endl;
    vLib4.insert(vLib4.begin() ,(size_t)1, 45);
...
void    erase_test()
{
    ...
    my.push_back(11);
    my.push_back(5);
    std::cout << "ERASE LIB, ret value: " << *lib.erase(lib.begin()) << std::endl;
    vector_info(lib, "lib", "erase");
    std::cout << "ERASE MY, ret value: " << *my.erase(my.begin()) << std::endl;
    vector_info(my, " my", "erase");

    std::cout << "ERASE LIB, ret value: " << *lib.erase(--lib.end()) << std::endl;
    vector_info(lib, "lib", "erase");
    std::cout << "ERASE MY, ret value: " << *my.erase(--my.end()) << std::endl;
    vector_info(my, " my", "erase");

    std::cout << "ERASE LIB, ret value: " << *lib.erase(lib.end() - 2) << std::endl;
    vector_info(lib, "lib", "erase");
    std::cout << "ERASE MY, ret value: " << *my.erase(my.end() - 2) << std::endl;
    vector_info(my, " my", "erase");
    ...
    std::cout << "ERASE LIB, ret value: " << *lib.erase(++lib.begin(), lib.end() - 2) << std::endl;
    vector_info(lib, "lib", "erase");
    std::cout << "ERASE MY, ret value: " << *my.erase(++my.begin(), my.end() - 2) << std::endl;
    vector_info(my, " my", "erase");
}
...
void    swap_test()
{
    ...
    my2.push_back(110);
    my2.push_back(50);
    std::cout << "Class function swap" << std::endl;
