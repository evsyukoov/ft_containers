...
{
    std::cout << "            CONSTRUCTORS && ASSIGNATION         " << std::endl;
    std::cout << "Default constructor lib: " << std::endl;
    std::list<int> lib;
    printList(lib);
    std::cout << "Default constructor my: " << std::endl;
    ft::list<int> my;
    printList(my);
    std::cout << "Constructor fill lib: " << std::endl;
    std::list<int> lib2((size_t) 3, 4);
    printList(lib2);
    std::cout << "Constructor fill my: " << std::endl;
    ...
    my2.push_back(1);
    my2.push_back(3);
    std::cout << "Constructor range lib: " << std::endl;
    std::list<int> lib3(lib2.begin(), lib2.end());
    printList(lib3);
    std::cout << "Constructor range my: " << std::endl;
    ft::list<int> my3(my2.begin(), my2.end());
    printList(my3);
    std::cout << "Constructor copy lib: " << std::endl;
    std::list<int> lib4(lib3);
    printList(lib4);
    std::cout << "Constructor copy my: " << std::endl;
    ft::list<int> my4(my3);
    printList(my4);
    std::cout << "Assignation operator lib: " << std::endl;
    lib4 = lib;
    printList(lib4);
    std::cout << "Assignation operator my: " << std::endl;
    my4 = my;
    printList(my4);
}
...
void    iterators_test()
{
    ...
    std::cout << "Iterators lib: " << std::endl;
    while (++itl != itle)
        std::cout << *itl << " ";
    std::cout << std::endl;
    std::cout << "Iterators my: " << std::endl;
    while (++itm != itme)
        std::cout << *itm << " ";
    std::cout << std::endl;
    ...
    std::cout << "Reverse Iterators lib: " << std::endl;
    while (++itlr != itlre)
        std::cout << *itlr << " ";
    std::cout << std::endl;
    std::cout << "Reverse Iterators my: " << std::endl;
    while (++itmr != itmre)
        std::cout << *itmr << " ";
    std::cout << std::endl;
}
...
void    capacity_test()
{
    ...
    std::list<int> lib;
    std::cout << "Empty lib: " << lib.empty() << " ,size = " << lib.size() << " ,list : " ;
    printList(lib);
    std::cout << std::endl;
    ft::list<int> my;
    std::cout << "Empty my:  " << my.empty() << " ,size = " << my.size() << " ,list : " ;
    printList(my);
    std::cout << std::endl;
    ...
    std::cout << "Max size lib = " << lib.max_size() << std::endl;
    std::cout << "Max size my  = " << my.max_size() << std::endl;
    std::cout << std::endl;
}
...
template<typename T, typename InputIterator>
void    erase_tests(T &container, const std::string &msg1, InputIterator pos1, InputIterator pos2, const std::string &msg2)
{
